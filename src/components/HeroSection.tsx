        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <p className="text-xl text-primary-foreground/90 mb-8 max-w-2xl">
              Connect top talent with leading hospitality companies. Whether you're hiring for events, 
              hotels, or restaurants, HotelHirePro makes bulk recruitment simple and efficient.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-12">
              ...
              <Button variant="outline" size="xl" className="bg-primary-foreground/10 border-primary-foreground/20 text-primary-foreground hover:bg-primary-foreground/20 group">
