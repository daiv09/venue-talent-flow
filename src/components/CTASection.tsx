      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-primary-foreground/90 max-w-3xl mx-auto">
            Join thousands of companies and professionals already using HotelHirePro 
            to streamline their hospitality recruitment process.
          </p>
        </div>
            ...
            <CardContent className="p-8">
              <div className="text-center mb-6">
                <div className="inline-flex items-center gap-2 bg-primary-foreground/20 px-4 py-2 rounded-full mb-4">
                  ...
                  <span className="font-semibold text-primary-foreground">For Companies</span>
                </div>
                <h3 className="text-2xl font-bold text-primary-foreground mb-2">
                  Start Hiring Today
                </h3>
                <p className="text-primary-foreground/80">
                  Post your first job and connect with qualified candidates instantly
                </p>
              </div>
            ...
            <CardContent className="p-8">
              <div className="text-center mb-6">
                <div className="inline-flex items-center gap-2 bg-primary-foreground/20 px-4 py-2 rounded-full mb-4">
                  ...
                  <span className="font-semibold text-primary-foreground">For Job Seekers</span>
                </div>
                <h3 className="text-2xl font-bold text-primary-foreground mb-2">
                  Find Your Next Role
                </h3>
                <p className="text-primary-foreground/80">
                  Browse thousands of hospitality opportunities and get hired faster
                </p>
              </div>
